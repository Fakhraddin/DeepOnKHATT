...
from load_hw_to_mem import get_handwriting_and_transcript, pad_sequences
...
def read_datasets(conf_path, sets, n_input, numcontext,
                  thread_count=8):
    ...
    Args:
        ...
        n_input (int):       Number of mel-frequency cepstral coefficients to compute.
    ...
    '''
    data_dir, dataset_config = _get_data_set_dict('neural_network.ini', sets)
...
class DataSet:
    ...
    def __init__(self, txt_files, thread_count, batch_size, n_input, numcontext):
        self._coord = None
    ...
    @classmethod
    def from_directory(cls, dirpath, thread_count, batch_size, n_input, numcontext, start_idx=0, limit=0, sort=None):
        ...
        return cls(txt_files, thread_count, batch_size, n_input, numcontext)
